...
| Windows installer creation | GPT/FAT32 + split WIM | consequence modal + polkit helper + live write | consequence modal + polkit helper + live write | Implemented on Linux |
